...
// モデルの最小値の設定処理
//----------------------------------------
void CDeadzoneX::SetVtxMin(D3DXVECTOR3 vtxMin)
{
	m_vtxMin = vtxMin;
}
...
// モデルの最大値の設定処理
//----------------------------------------
void CDeadzoneX::SetVtxMax(D3DXVECTOR3 vtxMax)
{
	m_vtxMax = vtxMax;
}
...
// モデルの最小値の取得処理
//----------------------------------------
D3DXVECTOR3 CDeadzoneX::GetVtxMin(void)
{
	return m_vtxMin;
}
...
// モデルの最大値の取得処理
//----------------------------------------
D3DXVECTOR3 CDeadzoneX::GetVtxMax(void)
{
	return m_vtxMax;
}
...
// 当たり判定の処理
//----------------------------------------
CDeadzoneX* CDeadzoneX::Collision(void)
{
	...
	CDeadzoneX* pDeadzoneX = nullptr;

	// 位置の取得
	D3DXVECTOR3 posDebris = pDeadzoneX->GetPos();

	// モデルの取得
	D3DXVECTOR3 vtxMin = pDeadzoneX->GetVtxMin();
	D3DXVECTOR3 vtxMax = pDeadzoneX->GetVtxMax();
