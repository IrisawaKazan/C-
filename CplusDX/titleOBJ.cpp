...
void CTitleObjX::Update(void)
{
	...
	if (m_nBlink == 60 * 7)
	{
		CEffect::Create(D3DXVECTOR3(1280.0f / 2.0f, 780.0f / 2.0f, 0.0f), D3DXCOLOR(1.0f, 1.0f, 1.0f, 0.4f), 700, 10/* 寿命 */, 25.0f, 25.0f); // 白

		pSound->PlaySoundA(pSound->SOUND_LABEL_LIGHT_SE);
	}
	if (m_nBlink == 60 * 7 + 40)
	{
		CEffect::Create(D3DXVECTOR3(1280.0f / 2.0f, 780.0f / 2.0f, 0.0f), D3DXCOLOR(1.0f, 1.0f, 1.0f, 0.4f), 700, 2/* 寿命 */, 25.0f, 25.0f); // 白
	...
	m_pos = D3DXVECTOR3(0.0f, 0.0f, m_fMove);
	...
	m_rot = D3DXVECTOR3(m_fRotation, 0.0f, 0.0f);
}
