...
{
	for (int nCount = 0; nCount < MAX_BULLETTEX; nCount++)
	{
		// テクスチャの破棄
				...
				{// 種類が敵の場合
					...
					if (BTYPE_PLAYER == true)
					{
							...
							&& pos.y <= EnemyPos.y + 55.0f)
						{
							...
							//{
							//	// 爆発を生成
							//	CExplosion::Create(EnemyPos, 50.0f, 50.0f, CExplosion::EXPLOTYPE_001);
							//}
							//else if (CEnemy::ETYPE_001)
							//{
							//	// 爆発を生成
