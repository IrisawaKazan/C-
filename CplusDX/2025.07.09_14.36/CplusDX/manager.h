...
#define MAX_FRAMECOUNTER (20)       // フレームカウンターの数
...
#define STARDUST_000_POS_X (300.0f) // STARDUST_000が湧く場所

#define MAX_COIN10_SPAWN (15)       // コインの湧く率(数字が小さいと出現しにくくなる)
#define COIN10_000_POS_X (300.0f)   // COIN10_000が湧く場所
